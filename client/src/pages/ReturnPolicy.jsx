  ...
  return (
    <section className="return-policy">
      ...
      <div>
        ...
        <p>
          You can only replace your order within 1 days of delivery.Replacement
          Policy: If you want to replace a product, please keep the product in
          the original packaging. In addition, the product must be unused and
          unwashed, with all tags intact.In case you are not available at
          delivery to check the quality of the product(s), you may raise a
          complaint within 2 hours of delivery. Similarly, in case any product
          is not delivered at the time of delivery, you may raise a complaint
          within 1 hours of delivery. To pass feedback to the merchants to
